...
<title>Ирий Сад: Сайты-партнеры, посвященные здоровому образу жизни.</title>
</head>
...
?>
        ...
        <td width="44%" align="right" valign="top" class="text" style="border-left:1px solid #FFFFFF;"><p><a href="http://www.blog.irysad.com" target="_blank">Записки голодающего сыроеда</a></p></td>
        <td width="44%" align="right" valign="top" class="text" style="border-left:1px solid #FFFFFF;">&nbsp;</td>
        </tr>
    </table></td>
  </tr>
<?php
